...
<template>
  <div class="min-h-screen bg-forge-950" :dir="locale === 'ar' ? 'rtl' : 'ltr'">
    <Navbar />

    <section class="relative z-10 py-24 px-6">
      <!-- Background glow -->
      <div class="absolute top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[300px] rounded-full bg-blue-600/8 blur-3xl pointer-events-none"></div>
      ...
      <div class="max-w-lg mx-auto">
        ...
        <div class="text-center mb-10">
          ...
          <p class="text-slate-400 text-base">{{ t('contact.subtitle') }}</p>
        </div>
        ...
        <div v-if="submitted" class="text-center py-16">
          ...
          <h3 class="text-lg font-600 text-white mb-2">{{ t('contact.successTitle') }}</h3>
          <p class="text-sm text-slate-400 mb-6">{{ t('contact.successDesc') }}</p>
        ...
        <form v-else @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div class="grid sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                class="w-full px-4 py-3 rounded-xl bg-slate-900 border text-sm text-white placeholder-slate-600 focus:outline-none focus:border-blue-500/50 transition-colors"
                :class="errors.name ? 'border-rose-500/50' : 'border-white/8'"
              />
            ...
            <div>
              ...
              <input
                ...
                class="w-full px-4 py-3 rounded-xl bg-slate-900 border text-sm text-white placeholder-slate-600 focus:outline-none focus:border-blue-500/50 transition-colors"
                :class="errors.email ? 'border-rose-500/50' : 'border-white/8'"
              />
          ...
          <div>
            ...
            <input
              ...
              class="w-full px-4 py-3 rounded-xl bg-slate-900 border border-white/8 text-sm text-white placeholder-slate-600 focus:outline-none focus:border-blue-500/50 transition-colors"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              class="w-full px-4 py-3 rounded-xl bg-slate-900 border text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors"
              :class="errors.subject ? 'border-rose-500/50' : 'border-white/8'"
            >
          ...
          <div>
            ...
            <textarea
              ...
              class="w-full px-4 py-3 rounded-xl bg-slate-900 border text-sm text-white placeholder-slate-600 focus:outline-none focus:border-blue-500/50 transition-colors resize-none"
              :class="errors.message ? 'border-rose-500/50' : 'border-white/8'"
            ></textarea>
            <div class="flex items-center justify-between mt-1">
              <p v-if="errors.message" class="text-[11px] text-rose-400">{{ t('contact.form.messageError') }}</p>
              <p class="text-[11px] text-slate-600 ms-auto">{{ form.message.length }}/1000</p>
            </div>
          </div>
          ...
          <p class="text-[11px] text-slate-600 text-center">{{ t('contact.form.privacy') }}</p>
