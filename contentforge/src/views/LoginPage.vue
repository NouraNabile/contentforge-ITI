          ...
          <div class="fields">
            <div v-if="isRegister" class="field-row">
              <div class="field">
                ...
                <input v-model="form.name" type="text" :placeholder="t('auth.fullNamePlaceholder')" @keyup.enter="submit"/>
              </div>
              <div class="field">
                <label>{{ t('auth.phone') }}</label>
                <input v-model="form.phone" type="tel" :placeholder="t('auth.phonePlaceholder')" @keyup.enter="submit"/>
              </div>
            </div>

            <div class="field">
              <label>{{ t('auth.email') }}</label>
              <input v-model="form.email" type="email" :placeholder="t('auth.emailPlaceholder')" @keyup.enter="submit"/>
            </div>
...
.feature-dot.teal   { background: #14b8a6; }
...
[dir="rtl"] .pass-toggle { right: auto; left: 12px; }
...
.switch-mode button:hover { color: #93c5fd; }
...
.otp-input:focus { border-color: rgba(99,102,241,0.6); }
