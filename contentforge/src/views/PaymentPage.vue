    ...
    <div class="max-w-3xl mx-auto px-4 py-8 space-y-8">
      ...
      <div class="flex items-center justify-center gap-3">
        ...
        <button
          ...
          :class="annual ? 'bg-blue-600' : 'bg-white/10'"
        >
          <span
        ...
        >
          {{ t("pricing.annual") }}
          <span
            class="ml-1.5 text-[11px] px-1.5 py-0.5 rounded-full bg-green-500/15 text-green-400 border border-green-500/20"
          >
            {{ t("pricing.save20") }}
          </span>
        </span>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        >
          ...
          <button
            ...
            :disabled="checkoutLoading === plan.key || currentPlan === plan.key"
