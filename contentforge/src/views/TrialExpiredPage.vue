...
<template>
  <div
    class="min-h-screen theme-bg flex items-center justify-center p-6 bg-grid"
  >
    ...
    <div class="w-full max-w-lg relative z-10">
      <div class="text-center mb-8">
        ...
        <h1 class="font-display text-2xl font-700 theme-text mb-2">
          {{ t("trial.title") }}
        </h1>
      ...
      <div class="rounded-2xl theme-surface theme-border p-8 theme-shadow">
        <p class="text-xs theme-sub font-medium mb-4 uppercase tracking-wider">
          {{ t("trial.choosePlan") }}
        </p>
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
          ...
          <div class="rounded-xl theme-card theme-border p-5 flex flex-col">
            <p class="text-sm font-600 theme-text mb-1">
              {{ t("trial.starter.name") }}
            </p>
            ...
            <p class="text-xs theme-muted mb-4">
              {{ t("trial.starter.desc") }}
            </p>
            <ul class="space-y-1.5 mb-5 flex-1">
              <li
                v-for="feature in starterFeatures"
                :key="feature"
                class="flex items-center gap-2 text-xs theme-sub"
              >
                <svg
          ...
          <!-- Pro Plan -->
          <div
            class="rounded-xl theme-card p-5 flex flex-col relative border-2 border-blue-500/40"
          >
            <span
        ...
        <Transition name="fade">
          <div
            v-if="showToast"
            class="mb-4 px-4 py-3 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-400 text-sm flex items-center gap-2"
          >
            <svg
        ...
        <button
          @click="logout"
          class="w-full py-3 rounded-xl theme-card theme-border theme-sub text-sm hover:theme-text transition-colors flex items-center justify-center gap-2"
        >
          <svg
            class="w-4 h-4"
            fill="none"
